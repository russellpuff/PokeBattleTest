...
namespace mv {
	...
	// Bullet Seed
	// Fury Attack
	void Hit2to5Times(bat::Battle& battle); // post

	// Dual Chop
	// Double Kick
	// Dual Wingbeat
	// Double Hit
	void HitTwice(bat::Battle& battle); // post
	...
	// Struggle Bug : 0/0/-1/-1/0/0/0, defender
	// Struggle Bug : 0/1/0/1/0/0/0, attacker
	// Quiver Dance : 0/0/1/1/1/0/0, attacker
	// Snarl : -1/0/-1/0/0/0/0, defender
	// Hone Claws : 1/0/0/0/0/1/0, attacker
	// Dragon Dance : 1/0/0/0/1/0/0, attacker
	// Magnetic Flux : 0/1/0/1/0/0/0, attacker
	// Baby Doll Eyes : -1/0/-1/0/0/0/0, defender
	// Mystical Flame :  -1/0/-1/0/0/0/0, defender
	// Barrier Rush : 0/1/0/1/0/0/0, attacker
	// Calm Mind : 0/0/1/1/0/0/0, attacker
	// Cosmic Power : 0/1/0/1/0/0/0, attacker
	// Close Combat : 0/-1/0/-1/0/0/0, attacker
	// Bulk Up: 1/1/0/1/0/0/0, attacker
	// No Retreat: 1/1/1/1/1/0/0, attacker
	// Victory Dance: 2/1/0/0/0/0/0, attacker
	// Coil : 1/1/0/0/0/1/0, attacker
	// Headlong Rush : 0/-1/0/-1/0/0/0, attacker
	// Barricade : 0/1/0/0/0/0/1, attacker
	// Shift Gear : 1/0/0/0/2/0/0, attacker
	// Confide : -1/0/-1/0/0/0/0, defender
	// Howl : 1/0/1/0/0/0/0, attacker
	// Noble Roar : -2/0/-2/0/0/0/0, defender
	// Swords Dance : 2/0/2/0/0/0/0, attacker
	// Tickle : -1/-1/0/0/0/0/0, defender
	// Work Up : 1/0/0/0/1/0/0, attacker
	void ModMultipleStats(bat::Battle& battle, int atk, int def, int spatk, int spdef, int spd, int acc, int eva, bool targetAttacker);
